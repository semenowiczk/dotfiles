...
- The installation and runcom setup is
  [tested weekly on real Ubuntu and macOS machines](https://github.com/semenowiczk/dotfiles/actions)
...
```bash
bash -c "`curl -fsSL https://raw.githubusercontent.com/semenowiczk/dotfiles/master/remote-install.sh`"
```
...
[GitHub Action](https://github.com/semenowiczk/dotfiles/actions).
